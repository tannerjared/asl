...
input_dir = '/blue/jjtanner/shared/proact/dcm2bids/derivatives/asl/processed/asl2mniSmAvgSub'
output_dir = '/blue/jjtanner/shared/proact/dcm2bids/derivatives/asl/processed/asl2mniSmAvgSub_flipped'
...
# Set of filenames to be flipped
flip_filenames = {f'sub-{subj_id}_task-pain-minus-task-rest.nii.gz' for subj_id in subject_ids}
...
for filename in os.listdir(input_dir):
    ...
    if filename in flip_filenames:
        ...
        # Input and output directories
input_dir = '/blue/jjtanner/shared/proact/dcm2bids/derivatives/asl/processed/asl2mniSmAvgSubTaskRest'
output_dir = '/blue/jjtanner/shared/proact/dcm2bids/derivatives/asl/processed/asl2mniSmAvgSubTaskRest_flipped'
...
# Set of filenames to be flipped
flip_filenames = {f'sub-{subj_id}_task-rest-minus-task-pain.nii.gz' for subj_id in subject_ids}
